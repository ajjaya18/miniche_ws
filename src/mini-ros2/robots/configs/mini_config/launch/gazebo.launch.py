...
def generate_launch_description():
    ...
    descr_pkg_share = launch_ros.substitutions.FindPackageShare(
        package="mini_description"
    ).find("mini_description")
    ...
    default_world_path = os.path.join(config_pkg_share, "worlds/ramel.world")
    ...
    declare_robot_name = DeclareLaunchArgument(
        "robot_name", default_value="mini", description="Robot name"
    )
    ...
    declare_world_init_z = DeclareLaunchArgument("world_init_z", default_value="0.550")
